...
function Client(opts) {
  ...
  var companies = {
    ...
    getContactIds: function(id, cb) {
      ...
      sendRequest({
        method: 'GET',
        url: self.baseUrl + '/companies/v2/companies/' + id + '/vids'
      }, cb);
    },
    create: function(data, cb) {
      sendRequest({
    ...
    addContact: function(companyId, vid, cb) {
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + '/companies/v2/companies/'+companyId+'/contacts/'+vid
      }, cb);
    },
    update: function(companyId, data, cb) {
      sendRequest({
        method: 'PUT',
        url: self.baseUrl + '/companies/v2/companies/' + companyId + '/',
        body: data
      }, cb);
    }
  };
  ...
  var files = {
    ...
    upload: function(folder_paths, file, cb) {
      var formData = {
  ...
  var engagements = {
    ...
    getAssociatedEngagements: function (objectType, objectId, cb) {
      sendRequest({
        method: 'GET',
        url: self.baseUrl + '/engagements/v1/engagements/associated/'+objectType+'/'+objectId+'/paged?limit=100'
      }, cb);
    }
  };
